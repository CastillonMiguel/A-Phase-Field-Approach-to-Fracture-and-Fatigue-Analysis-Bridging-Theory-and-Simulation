...
// gmsh specimen_3_H08.geo -2 -o specimen_3_H08.msh
//
//      *------------------------------------* -
//      |                                    | |
//      |  _  /-----\                        | |
...
Field[8].XMin =  xa-(0.5)*Da;
Field[8].XMax =  xb +(0.5)*Db;
Field[8].YMin =  hb;
Field[8].YMax =  ha -(0.1)*Da;
...
Field[88].XMin =  g;
Field[88].XMax =  xb +(0.5)*Db;
Field[88].YMin =  hb-0.02*b;
Field[88].YMax =  H + 2.5;
...
Field[14] = Min;
Field[14].FieldsList = {8, 88, 66, 77, 100};
Background Field = 14;
