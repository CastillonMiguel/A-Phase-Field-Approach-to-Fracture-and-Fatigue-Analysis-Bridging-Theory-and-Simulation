r"""
.. _ref_example_geo_specimen_4_Hminus16:
...
Below is the .geo file used for the specimen 4:

Reference
---------

.. include::  ../../../../examples/GmshGeoFiles/Compact_specimen/specimen_4_Hminus16.geo
   :literal:
...
# %%
# Open the .geo file
geo_file = os.path.join(folder, "specimen_4_Hminus16.geo")
gmsh.open(geo_file)
...
if save_image:
   ...
   # Save the screenshot
   image_file = os.path.join(folder, "specimen_4_Hminus16.png")
